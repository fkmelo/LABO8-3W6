...
namespace ZombieParty.Migrations
{
    ...
    [Migration("20260925163716_Huntinglogss")]
    partial class Huntinglogss
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZombieParty.Models.HuntingLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Nettoyage complet des entrepôts abandonnés près du port.",
                            Title = "Zone Industrielle"
                        },
                        new
                        {
                            Id = 2,
                            Description = "Rapport de patrouille nocturne et sécurisation du périmètre.",
                            Title = "Secteur Nord"
                        },
                        new
                        {
                            Id = 3,
                            Description = "Recherche de survivants et élimination d'une petite horde errante.",
                            Title = "Forêt Sombre"
                        });
                });
